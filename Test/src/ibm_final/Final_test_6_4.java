...
public class Final_test_6_4 {
	...
	public static void main(String[] args) {
		...
		Dispather dispather = new Final_test_6_4().new Dispather();
		...
		// 这里就一个线程
		new Final_test_6_4().new SumbmitFactory(dispather).start();
				...
				new Thread(new Runnable() {
					...
					public void run() {
						...
						while (index < TaskNumer) {
							...
							new Thread(new Final_test_6_4().new Submit(dispather, submitter), "提交线程：".concat(uuid))
									.start();
							index++;
