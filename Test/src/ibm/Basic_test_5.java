...
import ibm.Basic_ok_4.Submit;
import ibm.Basic_ok_4.Submitter;
...
public class Basic_test_5 {
	...
	public static void main(String[] args) {
		...
		Dispather dispather = new Basic_test_5().new Dispather();
		...
		//这里就一个线程
		new Basic_test_5().new SumbmitFactory(dispather).start();
				...
				new Thread(new Runnable() {
					...
					public void run() {
						...
						while (index < 20) {
							...
							Submitter submitter = new Basic_test_5().new Submitter(c, String.valueOf(index));

							new Thread(new Basic_test_5().new Submit(dispather, submitter), "提交线程：".concat(Thread.currentThread().getName()))
									.start();
							index++;
