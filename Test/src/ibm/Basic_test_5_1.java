...
public class Basic_test_5_1 {
	...
	public static void main(String[] args) {
		...
		Dispather dispather = new Basic_test_5_1().new Dispather();
		...
		new Basic_test_5_1().new SumbmitFactory(dispather).start();
			...
			for(int i =0 ; i <10;++i) {
				...
				new Thread(new Runnable() {
					...
					public void run() {
						...
						Submitter submitter = new Basic_test_5_1().new Submitter(c, String.valueOf(index));
						
						new Basic_test_5_1().new Submit(dispather, submitter);
						
						
					}
				},"提交线程：".concat(String.valueOf(index))).start();
