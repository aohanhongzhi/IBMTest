...
public class Basic_test_6_1 {
	...
	public static void main(String[] args) {
		...
		Dispather dispather = new Basic_test_6_1().new Dispather();
		...
		//这里就一个线程
		new Basic_test_6_1().new SumbmitFactory(dispather).start();
				...
				new Thread(new Runnable() {
					...
					public void run() {
						...
						while (index < 20) {
							...
							Submitter submitter = new Basic_test_6_1().new Submitter(c,uuid);

							
							//通过Unix时间戳无法区分线程
							
							new Thread(new Basic_test_6_1().new Submit(dispather, submitter), "提交线程：".concat(uuid))
									.start();
							index++;
